...
<header 
	class="header-classic header-classic-3 site-header <?php if ( $custom_header_sticky == 1 ) : ?> header-sticky<?php endif; ?> ">
	...
	<div class="header-container">
		...
		<nav class="main-navigation show-for-large align_left">
